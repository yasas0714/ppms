...
<?php
	...
	if(!empty($_SESSION['UNI1'])){

		$University = $_SESSION['UNI1'] ;
...
for($x = 1;$x <= $coun['count(No)']; $x++){
	...
	$sql3 = "SELECT * FROM pastpaper WHERE No='".$x."' and University='".$University."'";
	...
	if(empty($result)){
		...
		$linkadd =  "../Upload past paper/$Location/$Subject.pdf";
	...
	elseif (!empty($_SESSION['UNI2'])) {

		
		$University = $_SESSION['UNI2'] ;
...
for($x = 1;$x <= $coun['count(No)']; $x++){
	...
	$sql3 = "SELECT * FROM pastpaper WHERE No='".$x."' and University='".$University."' and Faculty='".$Faculty."'";
	$detail = mysqli_query($conn,$sql3);
	$result = mysqli_fetch_assoc($detail);
...
elseif (!empty($_SESSION['UNI3'])) {

		
		$University = $_SESSION['UNI3'] ;
		$Faculty    = $_SESSION['FAC'] ;
		$Degree     = $_SESSION['DEG'] ;
...
for($x = 1;$x <= $coun['count(No)']; $x++){
	...
	$sql3 = "SELECT * FROM pastpaper WHERE No='".$x."' and University='".$University."' and Faculty='".$Faculty."' and Degree='".$Degree."'";
	$detail = mysqli_query($conn,$sql3);
	$result = mysqli_fetch_assoc($detail);
	...
	elseif (!empty($_SESSION['UNI4'])) {

		
		$University = $_SESSION['UNI4'] ;
		$Faculty    = $_SESSION['FAC'] ;
		$Degree     = $_SESSION['DEG'] ;
		$Year       = $_SESSION['YER'] ;
...
for($x = 1;$x <= $coun['count(No)']; $x++){
	...
	$sql3 = "SELECT * FROM pastpaper WHERE No='".$x."' and University='".$University."' and Faculty='".$Faculty."' and Degree='".$Degree."' and Year='".$Year."'";
	$detail = mysqli_query($conn,$sql3);
	$result = mysqli_fetch_assoc($detail);
	...
	elseif (!empty($_SESSION['UNI5'])) {

		
		$University = $_SESSION['UNI5'] ;
		$Faculty    = $_SESSION['FAC'] ;
		$Degree     = $_SESSION['DEG'] ;
		$Year       = $_SESSION['YER'] ;
...
for($x = 1;$x <= $coun['count(No)']; $x++){
	...
	$sql3 = "SELECT * FROM pastpaper WHERE No='".$x."' and University='".$University."' and Faculty='".$Faculty."' and Degree='".$Degree."' and Year='".$Year."'and Semester='".$Semester."'";
	$detail = mysqli_query($conn,$sql3);
	$result = mysqli_fetch_assoc($detail);
	...
	elseif (!empty($_SESSION['UNI6'])) {

		
		$University = $_SESSION['UNI6'] ;
		$Faculty    = $_SESSION['FAC'] ;
		$Degree     = $_SESSION['DEG'] ;
		$Year       = $_SESSION['YER'] ;
		$Semester   = $_SESSION['SEM'] ;
...
for($x = 1;$x <= $coun['count(No)']; $x++){
	...
	$sql3 = "SELECT * FROM pastpaper WHERE No='".$x."' and University='".$University."' and Faculty='".$Faculty."' and Degree='".$Degree."' and Year='".$Year."'and Semester='".$Semester."' and Subject='".$Subject."'";
	$detail = mysqli_query($conn,$sql3);
	$result = mysqli_fetch_assoc($detail);
